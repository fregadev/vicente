...
import ConfirmaCadastro from "../components/confirma-cadastro"

export default function CadastroPage() {
  const classes = useStyles()
  const [fields, setFields] = useState({})

  const [cadastroStatus, setCadastroStatus] = useState(`initial`)
  ...
  return (
    <Container component="main" maxWidth="xs">
      ...
      <div className={classes.paper}>
        ...
        {
          cadastroStatus === "initial" ? (<form className={classes.form} noValidate onSubmit={handleSubmission}>
